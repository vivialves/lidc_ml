...
def objective(trial):
    ...
    model = DenseNet3DWithSE(
        ...
        out_channels=NUM_CLASSES # Fixed for your LIDC classification task
    ).to(device)
...
if __name__ == '__main__':
    ...
    study = optuna.create_study(
        study_name="lidc_densenet_se_optimization",
        direction='maximize',
    ...
    starting = "Starting Optuna optimization for DenseNet3DWithSE..."
    print(starting)

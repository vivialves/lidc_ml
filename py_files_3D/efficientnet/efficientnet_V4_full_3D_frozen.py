...
def get_transforms():
    return Compose([
        ...
        # RandRotate(range_x=0.2, range_y=0.2, range_z=0.2, prob=0.7), # prob=0.5
        # RandAffine(
        ...
        # RandZoom(min_zoom=0.85, max_zoom=1.15, prob=0.7),
...
class EfficientNet3DClassifier(nn.Module):
    def __init__(self, model_name, in_channels, num_classes, classifier_dropout_rate, reduction_ratio):
        super().__init__()
        ...
        self.attention = SeAttBlock(conv_head_channels, reduction_ratio=reduction_ratio)

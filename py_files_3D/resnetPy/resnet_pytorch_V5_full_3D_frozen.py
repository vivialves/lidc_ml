...
train_loader = DataLoader(frozen_dataset_train, batch_size=BATCH_SIZE, num_workers=NUM_WORKERS, sampler=sampler_train, worker_init_fn=seed_worker, generator=g)
...
val_loader = DataLoader(frozen_dataset_val, batch_size=BATCH_SIZE, num_workers=NUM_WORKERS, sampler=sampler_val, worker_init_fn=seed_worker, generator=g)
...
test_loader = DataLoader(frozen_dataset_test, batch_size=BATCH_SIZE, num_workers=NUM_WORKERS, sampler=sampler_test, worker_init_fn=seed_worker, generator=g)
...
with torch.no_grad():
    for batch in val_loader:
        ...
        outputs = model.forward_features(inputs)  # before final FC

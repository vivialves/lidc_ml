...
# train_cache = SmartCacheDataset(data=train_dataset, transform=get_transforms(), replace_rate=0.2, cache_num=30, num_init_workers=0)
# val_cache = SmartCacheDataset(data=val_dataset, transform=get_transforms(), replace_rate=0.2, cache_num=30, num_init_workers=0)
# test_cache = SmartCacheDataset(data=test_dataset, transform=get_transforms(), replace_rate=0.2, cache_num=30, num_init_workers=0)
